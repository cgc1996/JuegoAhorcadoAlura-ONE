var inputPersonalizado= document.querySelector(".text-input");
var palabraPersonalizada=""
var palabraElegida=""

function agregarPalabraPersonalizada(){
    palabraPersonalizada=inputPersonalizado.value.toUpperCase();
    inputPersonalizado.value=""
    
    return palabraPersonalizada
...
function esperarPalabraPersonalizada(){
    if(inputPersonalizado!=""){
        document.addEventListener("keyup", function(event){
        if(event.key=="Enter"){
            palabraElegida=agregarPalabraPersonalizada()
