...
var palabras=["DEVOPS","ALURA","ORACLE","JAVASCRIPT","HTML","JAVA","PHYTON","TECLADO","MOUSE","MONITOR","PARLANTE","MEMORIA","RAM"];
var palabraElegida= palabras[Math.round(Math.random()*((palabras.length)-1))];
var letras=[];
var palabraCorrecta = "";
var errores=7;
